 ...
 *         _id:
 *           type: string
 *           description: The meeting room id generated by MongoDB.
 *         roomName:
 *           type: string
 *           description: Optional name of the meeting room.
 *         creator:
 *           type: string
 *           description: The user id of the creator who created the meeting room.
 *         participant:
 *           type: array
 *           description: List of user ids who are participants of the meeting room.
 *           items:
 *             type: string
 *         createdAt:
 *           type: string
 *           format: date-time
 *           description: The time when the meeting room was created.
 *         updatedAt:
 *           type: string
 *           format: date-time
 *           description: The time when the meeting room was last updated.
 *       required:
 *         - _id
 *         - creator
 *         - participant
 ...
 *     description: Create a new meeting room with the given creatorId.
 *     tags:
 *       - Meeting
 *     requestBody:
 *       required: true
 ...
 *               creatorId:
 *                 type: string
 *                 description: The ID of the user creating the meeting room.
 *     responses:
 *       201:
 ...
 *                 roomId:
 *                   type: string
 *                   description: The generated room ID.
 *                 creatorId:
 *                   type: string
 ...
 *       400:
 *         description: Bad request - Missing or invalid creatorId.
 *       500:
 *         description: Internal server error.
 * /meetings/info:
 *   post:
 *     summary: Get meeting room participants
 *     description: Retrieve the participant list of a specific meeting room by roomId.
 *     tags:
 *       - Meeting
 *     requestBody:
 *       required: true
